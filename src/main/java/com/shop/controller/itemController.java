...
public class itemController {
    ...
    public String itemForm(Model model, Principal principal){
        Member member = memberService.findUser(principal.getName());
    ...
    public String itemDtl(@PathVariable("itemId") Long itemId, Model model){
        try{
            ...
            Item item = itemService.getItem(itemFormDto.getId()).get();
            Member member = memberService.findUser(item.getCreatedBy());
            model.addAttribute("member", member);
